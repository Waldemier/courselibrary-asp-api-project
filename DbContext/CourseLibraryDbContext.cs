        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Author>().HasData(
                new Author()
                {
                    ...
                    DateOfBirthday = new DateTime(1668, 5, 21),
                    MainCategory = "Ships"
                },
                new Author()
                {
                ...
                new Author()
                {
                    ...
                    DateOfBirthday = new DateTime(1701, 12, 16),
                ...
                new Author()
                {
                    ...
                    DateOfBirthday = new DateTime(1702, 3, 6),
                    MainCategory = "Singing"
                },
                new Author()
                {
                    ...
                    DateOfBirthday = new DateTime(1690, 11, 23),
                    MainCategory = "Maps"
                },
                new Author()
                {
                    ...
                    DateOfBirthday = new DateTime(1723, 4, 5),
                ...
                new Author()
                {
                    ...
                    DateOfBirthday = new DateTime(1721, 10, 11),
                    MainCategory = "Rum"
                }
            );
